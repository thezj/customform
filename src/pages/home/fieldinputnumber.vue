            ...
            <el-row :gutter="24">
                <el-col :span="12">
                    <el-form-item label="最小值">
                        <el-input-number v-model="fielddata.min" controls-position="right" @change="handleChange" :min="0" :max="fielddata.max-1"></el-input-number>
                    </el-form-item>
                </el-col>
                <el-col :span="12">
                    <el-form-item label="最大值">
                        <el-input-number v-model="fielddata.max" controls-position="right" @change="handleChange" :min="fielddata.min+1"></el-input-number>
                    </el-form-item>
                </el-col>
            </el-row>
            <el-row :gutter="24">
